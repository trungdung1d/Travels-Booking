        ...
        <div class="col-lg-12 col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a target="_blank" href="{{URL::to('details-booking/'.$contract->booking_id)}}"><label for="" class="control-label col-form-label">{{__("Details")}}</label></a>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <input disabled class="form-control" type="text" value="" placeholder="Booking code: {{$contract->booking_code}}    &nbsp&nbsp&nbsp&nbsp&nbsp  Date: {{$contract->created_at}}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <form role="form" action="{{URL::to('/update-contract')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field() }}
                    <input type="hidden" value="{{$contract->contract_id}}" name="contract_id">
                    <div class="card-body">
                        <?php
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" class="form-control" value="{{$contract->staff_name}}" id="" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                   <a href=""> <label for="" class="control-label col-form-label">{{__("Customer")}}</label></a>
                                    <input disabled type="text" class="form-control" id="" value="{{$contract->booking_customer_name}}" name="">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input disabled  type="text" class="form-control" value="{{$contract->staff_id}}" id="" name="">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="" class="control-label col-form-label">{{__("Customer phone")}}</label>
                                    <input disabled type="text" class="form-control" id="" value="{{$contract->booking_customer_phone_domain}} {{$contract->booking_customer_phone_number}}" name="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <input disabled   name="contract_total_price" id="only_numb" class="form-control" value="{{$contract->contract_total_price}} đ">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <input  disabled type="date" class="form-control" value="{{$contract->contract_date}}" placeholder=" " name="contract_date">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-12">
                        <iframe src="{{asset('Admins/contract_pdf/'.$contract->contract_file)}}" frameborder="0" style="width: 100%" height="600px"></iframe>
                    </div>
                </div>
            </div>
        </div>
