    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">{{__('Edit Destination')}}</h4>
                ...
                <form role="form" action="{{URL::to('/update-destination/'.$edit_Dest->destination_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex no-block align-items-center">
                            <h4 class="card-title">{{__('EDIT TOUR DESTINATION')}}</h4>
                        </div>
                        <div class="row">
                            <div class="col-12">
                    ...
                    <div class="card-body">
                        <div class="action-form">
                            <div class="form-group m-b-0 text-center">
                                ...
                                <a href="{{URL::to('/list-destination')}}" class="btn btn-dark waves-effect waves-light">{{__('Cancel')}}</a>
                            </div>
                        </div>
                    </div>
                </form>
