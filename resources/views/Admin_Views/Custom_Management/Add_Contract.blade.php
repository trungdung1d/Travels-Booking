...
@section('content')
    ...
    <div class="container">
        <div class="col-lg-12 col-lg-6">
            <div class="card">
                <div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a target="_blank" href="{{URL::to('details-custom/'.$custom->custom_id)}}"><label for="" class="control-label col-form-label">{{__("Details")}}</label></a>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <input disabled class="form-control" type="text" value="" placeholder="custom code: {{$custom->custom_code}}    &nbsp&nbsp&nbsp&nbsp&nbsp  Date: {{$custom->created_at}}">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <form role="form" action="{{URL::to('/save-custom-contract')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field() }}
                    <input type="hidden" value="{{$custom->custom_id}}" name="custom_id">
                    <div class="card-body">
                        <?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" class="form-control" id="" value="{{$custom->custom_customer_name}}" name="">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" class="form-control" id="" value=" {{$custom->custom_customer_phone}}" name="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <input required onkeypress="return fun_AllowOnlyAmountAndDot(this.id)" name="custom_contract_total_price" id="only_numb" class="form-control" placeholder="$ {{$custom->custom_spend}} ">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <input required type="date" class="form-control" placeholder=" " name="custom_contract_date">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <input required type="file" class="form-control" placeholder=" " name="custom_contract_file"  accept="application/pdf,application/vnd.ms-excel" />
                                </div>
                            </div>
                        </div>
                    </div>
