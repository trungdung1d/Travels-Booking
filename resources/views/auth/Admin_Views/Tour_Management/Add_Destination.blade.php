    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">{{__('Add Destination')}}</h4>
                ...
                <form role="form" action="{{URL::to('/save-destination')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex no-block align-items-center">
                            <h4 class="card-title">{{__('ADD TOUR DESTINATION')}}</h4>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleTextarea2" rows="4" placeholder="{{__('Desc Here')}}" name="dest_desc_VI"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="control-label col-form-label">{{__('Desc in English')}}</label>
                                    <textarea class="form-control" id="exampleTextarea2" rows="4" placeholder="{{__('Desc Here')}}" name="dest_desc_EN"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                    ...
                    <div class="card-body">
                        <div class="action-form">
                            <div class="form-group m-b-0 text-center">
                                ...
                                <a href="{{URL::to('/add-destination')}}" class="btn btn-dark waves-effect waves-light">{{__('Cancel')}}</a>
                            </div>
                        </div>
                    </div>
                </form>
